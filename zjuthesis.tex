...
\documentclass[
    ...
    ColaboratorName = 陶煜波,
    % Title
    Title           = 嵌入表征在体数据中的学习与应用,
    TitleEng        = {{Learning and Application of the Representations of Volumes}}
]{zjuthesis}
...
\titleengtwolines{Learning and Application of}{the Representations of Volumes}
